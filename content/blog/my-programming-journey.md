---
title: My programming journey - tools for self-learning
slug: my-programming-journey
date: 2022-07-11
excerpt: I'm a self-taught programmer, and this is a collection of my favorite resources, content, courses, and everything else that I used in year 1.
tags: [engineering, learning, programming, development]
published: true
---

# Context

This is a collection of some of my favorite resources, content, courses, and everything else that I used to for the past 5 years (and counting).
I wasn't very consistent with updating it, so it's probably missing a lot but I'll try to fill in the gaps slowly.
...
- At first, I didn't know which language to pick. I didn't even understand how to pick one. Getting started with an open mind helped me narrow down on which I should pick. It ended up being Python, but I tried many different languages before I settled.
    ...
    - If you're all in on Python, look no further than the [fullstackpython.com](https://www.fullstackpython.com/) website, which covers everything form the basics of Python itself to SQL ORMs, HTML template engines, and Deployment options
...
*At a certain point the questions I had stopped being about languages or frameworks.
I started wondering how best to structure my codebase, maximize my productivity, and optimize my code.*
...
- This book by Googler Jeremy Kun is a fresh take on Math for Programmers [Dr. Jeremy Kun - A Programmer’s Introduction to Mathematics (2018).pdf](https://www.notion.so/My%20Programming%20Journey%208bffcf473b344ee08f7b611d9c797dc0/Dr._Jeremy_Kun_-_A_Programmers_Introduction_to_Mathematics_(2018).pdf).
