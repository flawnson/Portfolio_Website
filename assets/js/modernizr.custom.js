...
!function (e, n, t) {
    ...
    function a() {
        ...
        for (var l in f) if (f.hasOwnProperty(l)) {
            ...
            for (a = o(n.fn, "function") ? n.fn() : n.fn, s = 0; s < e.length; s++) i = e[s], r = i.split("."), 1 === r.length ? Modernizr[r[0]] = a : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = a), d.push((a ? "" : "no-") + r.join("-"))
        }
    }
    ...
    c.mq = m, Modernizr.addTest("mediaqueries", m("only all")), a(), s(d), delete c.addTest, delete c.addAsyncTest;
